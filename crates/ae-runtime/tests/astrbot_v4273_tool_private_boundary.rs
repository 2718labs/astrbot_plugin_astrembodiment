...
fn v4273_invocation_domain_uses_sha256_text_leaf_and_big_endian_revision() {
    ...
    let text_sha256 = [
        0x57, 0xee, 0x01, 0x5b, 0x35, 0xa6, 0xc0, 0x0b, 0x10, 0x49, 0x00, 0x25, 0x4a, 0x65, 0xde,
        0x49, 0x01, 0x0b, 0x14, 0x51, 0x69, 0x20, 0x5d, 0xc2, 0x8a, 0xd5, 0x0f, 0x2b, 0xec, 0x10,
        0xd7, 0xf3,
    ];
...
fn v4273_tool_registry_and_public_dtos_exclude_raw_text() {
    const PRIVATE_REGISTRY_SENTINEL: &str = "PRIVATE_REGISTRY_7be1f2557ee84c978f3f675fbccf8379";
