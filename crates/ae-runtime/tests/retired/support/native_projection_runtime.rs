use super::{BoundedProjectionReferencesV1, NativeProjectionUpdateV1};
...
use ae_contracts::r7::{
    wire, CausalRef, Digest, EvidenceVector, Id128, ScopeRef, SemanticEstimate,
};
...
// This runtime-unit fixture constructs a fully bound legacy native update for
// transaction-boundary regressions without exposing a production sealer.
