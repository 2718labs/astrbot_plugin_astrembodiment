#[allow(unused_macros)]
macro_rules! lark_public_effect_boundary_test_contents {
    () => {
        use crate::r7::{AstrRuntime, RuntimeError};
        use ae_contracts::r7::{
            wire, DeliveryKnowledgeV1, HostContractErrorV1, HostEffectDispositionV1, HostEffectV1,
            HostIngressKindV1, HostIngressV1, HostSettlementStatusV1, HostSettlementV1,
            PublicTextV1, HOST_SCHEMA_V1, LARK_PUBLIC_EFFECT_V1, PUBLIC_TEXT_V1,
        };
        ...
        fn canonical_public_effect() -> HostEffectV1 {
            let mut effect = HostEffectV1 {
                ...
                public_payload: Some(
                    PublicTextV1::new("canonical public reply".to_owned()).unwrap(),
                ),
        ...
        fn settlement_reenters_runtime_as_typed_ingress() {
            ...
            let ingress =
                HostIngressV1::for_settlement(settlement.clone(), runtime.current_revision());
        ...
        fn issued_effect_settlement_requires_exact_correlation() {
            ...
            let mismatched_ingress =
                HostIngressV1::for_settlement(mismatched, runtime.current_revision());
            assert_eq!(
