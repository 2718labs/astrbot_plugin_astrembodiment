    ...
    () => {
        ...
        fn prepared_semantic_transition_commits_only_with_a_matching_pre_output_wire() {
            ...
            assert_eq!(
                wire.wire_digest(),
                &[
                    0xa4, 0x37, 0x32, 0x88, 0x15, 0xd2, 0x25, 0x79, 0x8d, 0xb0, 0x51, 0x5d, 0xc3,
                    0x07, 0x6c, 0x89, 0x9c, 0x02, 0xb3, 0x07, 0xa3, 0x61, 0x04, 0x72, 0x85, 0xbd,
                    0xa2, 0xb6, 0x1d, 0x64, 0xef, 0xd2,
                ],
